...
"United Kingdom","Georgia","Ghana","Guinea","The Gambia","Equatorial Guinea","Greece",
...
function WorldMap() {
  ...
  ></path>
  <path d="M1070.6 190.8l-.3.8.7 2.1-.2 2.6h-2.8l1.1 1.4-1.3 4-.9 1.1-4.4.1-2.4 1.5-4.2-.5-7.3-1.7-1.3-2.1-4.9 1.1-.5 1.2-3.1-.9-2.6-.2-2.3-1.2.7-1.5-.2-1.1 1.4-.3 2.7 1.7.6-1.7 4.4.3 3.5-1.1 2.4.2 1.7 1.3.4-1.1-1-4.1 1.7-.8 1.6-2.9 3.8 2.1 2.6-2.6 1.7-.5 4 1.9 2.3-.3 2.4 1.2z"></path>
  <path
  ...
  <path
    ...
    fill={colorMap[covidMap["Canada"]]}
  ></path>
  <path d="M1034.4 197.5l.2 1.1-.7 1.5 2.3 1.2 2.6.2-.3 2.5-2.1 1.1-3.8-.8-1 2.5-2.4.2-.9-1-2.7 2.2-2.5.3-2.2-1.4-1.8-2.7-2.4 1v-2.9l3.6-3.5-.2-1.6 2.3.6 1.3-1.1h4.2l1-1.3 5.5 1.9z"></path>
  <path
  ...
  <path
    ...
    fill={colorMap[covidMap["United Kingdom"]]}
  ></path>
  <path
    ...
    fill={colorMap[covidMap["United Kingdom"]]}
  ></path>
  <path className="Georgia" d="M1215.7 227.9l5.1 1.3 2.1 2.6 3.6 1.5-1.2.8 3.3 3.5-.6.7-2.9-.3-4.2-1.9-1.1 1.1-7 1-5.6-3.2-5.5.3.3-2.7-2.1-4.3-3.4-2.4-3-.7-2.2-1.9.4-.8 4.6 1.1 7.7 1 7.6 3.1 1.2 1.2 2.9-1z"></path>
  <path className="Ghana" d="M986.5 431.1l-.4 2 2.3 3.3v4.7l.6 5 1.4 2.4-1.3 5.7.5 3.2 1.5 4.1 1.3 2.3-8.9 3.7-3.2 2.2-5.1 1.9-5-1.8.2-2.6-2.4-5.5 1.5-7.3 2.4-5.3-1.5-9.2-.8-4.8.2-3.7 9.8-.3 2.5.5 1.8-1 2.6.5z"></path>
  <path className="Guinea" d="M921.5 421.9l.3 2.4h.9l1.5-.9.9.2 1.6 1.7 2.4.5 1.5-1.4 1.9-.9 1.3-.9 1.1.2 1.3 1.4.6 1.8 2.3 2.7-1.1 1.6-.3 2.1 1.2-.6.7.7-.3 1.9 1.7 1.9-1.1.5-.5 2.2 1.3 2.6 1.4 5.2-2.1.7-.5.9.4 1.3-.4 2.8h-.9l-1.6-.2-1.1 2.6h-1.6l-1.1-1.4.4-2.6-2.4-3.9-1.4.7-1.3.2-1.5.3.1-2.3-.9-1.7.2-1.9-1.2-2.7-1.6-2.3h-4.5l-1.3 1.2-1.6.2-1 1.4-.6 1.7-3.1 2.9-2.4-3.8-2.2-2.5-1.4-.9-1.4-1.3-.6-2.8-.8-1.4-1.7-1.1 2.6-3.1 1.7.1 1.5-1 1.2-.1.9-.8-.4-2.1.6-.7.1-2.2 2.7.1 4.1 1.5 1.2-.1.4-.7 3.1.5.8-.4z"></path>
  <path className="The Gambia" d="M891.6 417.4l.8-2.9 6.1-.1 1.3-1.6 1.8-.1 2.2 1.6h1.7l1.9-1 1.1 1.8-2.5 1.5-2.4-.2-2.4-1.3-2.1 1.5h-1l-1.4.9-5.1-.1z"></path>
  <path className="Guinea-Bissau" d="M909.2 421l-.1 2.2-.6.7.4 2.1-.9.8-1.2.1-1.5 1-1.7-.1-2.6 3.1-2.9-2.6-2.4-.5-1.3-1.8.1-1-1.7-1.3-.4-1.4 3-1 1.9.2 1.5-.8 10.4.3z"></path>
  <path className="Equatorial Guinea" d="M1050.3 487.3v7.7h-8.2l-1.9.3-1.1-.9 1.9-7.2 9.3.1z"></path>
  <path
